...
const extraData = [
  ...
  {
    title: "Free Return",
    description: "Free shipping over $100", // Note: This looks like a copy-paste error in the image!
    icon: <GitCompareArrows size={45} />,
  },
  {
    title: "Customer Support",
    description: "Friendly 24/7 customer support", // Fixed "27/7" to "24/7"
        ...
        {brands?.map((brand) => (
          <Link
           ...
           href={{ pathname: "/shop", query: { brand: brand?.slug?.current } }}
            className="bg-white   rounded-md overflow-hidden hover:shadow-lg shadow-shop_dark_green/20 hoverEffect group "
          >
            {brand?.image && (
              <Image
