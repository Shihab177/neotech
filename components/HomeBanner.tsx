  ...
  return (
    <div className="py-16 md:py-0 bg-shop-light-pink rounded-b-lg px-10 md:px-24 flex items-center justify-between">
        <div className="space-y-5">
            ...
            <Link  href={"/shop"} className="bg-shop_dark_green/90 text-white  px-5 py-2 rounded-md text-sm font-semibold hover:text-white hover:bg-shop_dark_green hoverEffect">Buy Now</Link>
        </div>
    <div>
