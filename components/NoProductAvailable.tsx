...
const NoProductAvailable = ({ selectedTab, className }: NoProductAvailableProps) => {
  return (
    <div className={cn("flex flex-col items-center justify-center py-10 min-h-80 space-y-4 bg-gray-100/70 rounded-md", className)}>
      <motion.div
